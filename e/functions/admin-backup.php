...
?>
	<div class="wrap">
		...
		<h2><?php _e( 'Import/Export Settings', 'colabsthemes' ); ?></h2>
		
		<h3><?php _e( 'Import Settings', 'colabsthemes' ); ?></h3>
		...
		<h3><?php _e( 'Export Settings', 'colabsthemes' ); ?></h3>
...
<span class="description"><?php _e( 'This will contain all of the options listed below.', 'colabsthemes' ); ?></span></p>
			...
			<!--p><label for="content"><input type="radio" name="export-type" value="sidebar"<?php checked( 'sidebar', $export_type ); ?>> <?php _e( 'Sidebar Manager', 'colabsthemes' ); ?> <span class="description"><?php _e( 'This will contain only the custom sidebars themselves and not the widgets within them', 'colabsthemes' ); ?></span></label></p>
			
			<p><label for="content"><input type="radio" name="export-type" value="framework"<?php checked( 'framework', $export_type ); ?>> <?php _e( 'Framework Settings', 'colabsthemes' ); ?></label></p-->
...
<?php
	...
	function import() {
		...
		$upload = file_get_contents( $_FILES['colabsthemes-import-file']['tmp_name'] );
