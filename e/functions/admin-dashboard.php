   ...
   ?>
    ...
    <div class="wrap colabs_container">
        ...
        <div class="themever left">
            ...
            <h2><?php echo $themename; ?> <?php echo $local_version; ?>&nbsp;<?php _e( 'Dashboard','colabsthemes' ); ?></h2>
        </div>
			...
			<h3 class="hndle"><span><?php echo $themename; ?>&nbsp;<?php _e('Info', 'colabsthemes') ?></span></h3>
				...
				<div class="insider" id="boxy">
                    ...
                    <ul>
                        ...
                        <?php /*if($license){ ?><li><?php _e('License Type', 'colabsthemes')?>: <strong><?php echo $license; ?></strong> <?php if ($license != 'Developer Pack') { ?> (<a href="http://colorlabsproject.com/" target="_new"><?php _e('Upgrade', 'colabsthemes') ?></a>) <?php } ?></li><?php }*/ ?>
		...
		<!--div class="postbox">
			<div class="forumico"></div><a target="_new" href="<?php echo $colabs_forum_rss_feed ?>"><div class="rssico"></div></a>
			<h3 class="hndle" id="poststuff"><span><?php _e('ColorLabs Support', 'colabsthemes') ?></span></h3>

            <div class="preloader-container">
            <div class="insider" id="boxy">

			<?php colabs_dashboard_forum(); ?>
...
// CoLabs RSS forum feed for the dashboard page
function colabs_dashboard_forum() {
global $colabs_forum_rss_feed;
	wp_widget_rss_output($colabs_forum_rss_feed, array('items' => 5, 'show_author' => 0, 'show_date' => 1, 'show_summary' => 1));
}
