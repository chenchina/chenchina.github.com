...
class CoLabs_AdWidget extends WP_Widget {
	...
	function CoLabs_AdWidget() {
		$widget_ops = array('description' => 'A set of two 300px by 250px advertisements, use in Sidebar only.' );
		parent::WP_Widget(false, __('ColorLabs - Ad 300', 'colabsthemes'),$widget_ops);      
	}
