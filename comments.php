<?php global $post; 
		...
		?>
   <div id="comments" class="<?php if ($author==$adam){echo 'comment-adam';}else{echo 'comment-eve';}?>">
...
<?php if ( ! empty($comments_by_type['comment']) ) : ?>
    ...
    <div id="comments-list" class="comments">
     <h3><?php printf($comment_count > 1 ? __('<span>%d</span> Comments ', 'Continent') : __('<span>One</span> Comment ', 'Continent'), $comment_count) ?></h3>
