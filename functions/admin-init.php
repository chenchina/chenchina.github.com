...
function colabs_version_init() {
    ...
    $colabs_framework_version = '1.2.0';
...
define('COLABS_CUSTOM', STYLESHEETPATH . '/custom');
...
//require_once ($functions_path . 'install-script.php');              // Install script to create database tables and then insert default data.
/*-----------------------------------------------------------------------------------*/
