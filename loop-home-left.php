<?php
/**
 * The template for displaying left content in the home.php page template
 *
 * @package WordPress
 * @subpackage AdamEve
 * @since AdamEve 1.0
 */
?>
            <?php $exclude = ''; if (get_option('colabs_slider_exclude1') == "true") $exclude = get_option('colabs_exclude1'); ?>
                <?php 
		...
		<?php if (have_posts()) : ?>
                    <?php while (have_posts()) : the_post(); ?>
                        <div id="post-<?php the_ID(); ?>" <?php post_class('post-adam');?>> 
